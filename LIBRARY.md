...
## API Documentation Tools (api_docs/)

| Resource | File | Description |
|----------|------|-------------|
| Official Best Practices | [official_best_practices.md](api_docs/official_best_practices.md) | From Autodesk FusionMCPSample |
| Official Tips | [official_tips.md](api_docs/official_tips.md) | Prompt structure, use cases, CORSA template |
| API Doc Lookup Utility | [api_doc_lookup.py](api_docs/api_doc_lookup.py) | Python introspection of adsk module |
| frankhommers Design Guide | MCP tool: `fetch_design_guide` | Bundled guide with 17 best practices |
| Online API Docs | MCP tool: `fetch_online_documentation` | Autodesk cloudhelp documentation |

### How to Look Up API Documentation (Two-Pass Method)

1. **Pass 1: Discover** — Use `fetch_api_documentation` to find relevant classes/methods
2. **Pass 2: Detail** — Use `fetch_online_documentation` for exact signatures and samples
