...
MCP clients connect directly:
  {"mcpServers": {"brepwright": {"type": "http", "url": "http://127.0.0.1:8766/mcp"}}}
...
# Server info
SERVER_INFO = {"name": "brepwright", "version": "0.1.0"}
...
class MCPServer:
    ...
    def __init__(
        ...
        self.tool_input_schema = tool_input_schema or {
            ...
            "properties": {
                "operation": {
                    "type": "string",
                    "description": "Operation type: execute_python, capture_viewport, fetch_api_documentation, or fetch_design_guide. Omit for generic API calls.",
                },
                "api_path": {
                    "type": "string",
    ...
    def start(self):
        ...
        try:
            ...
            self.log(
                f'  "brepwright": {{"type": "http", "url": "http://127.0.0.1:{self.port}/mcp"}}'
            )
