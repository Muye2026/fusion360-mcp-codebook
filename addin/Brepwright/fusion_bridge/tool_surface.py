"""Central definitions for Brepwright MCP tools."""
...
# System and inspection (3)
PING = "ping"
GET_RUNTIME_STATUS = "get_runtime_status"
GET_ACTIVE_DESIGN_INFO = "get_active_design_info"

# Workflow-first tools (6)
CREATE_MOUNTING_PLATE = "create_mounting_plate"
CREATE_ENCLOSURE_SHELL = "create_enclosure_shell"
CREATE_BRACKET = "create_bracket"
INSPECT_DESIGN = "inspect_design"
EXPORT_DESIGN_PACK = "export_design_pack"
VALIDATE_PART_FOR_PRINTING = "validate_part_for_printing"
...
TOOL_DEFINITIONS = [
    ...
    {
        "name": PING,
        "description": "Lightweight Brepwright health check. Does not modify the active design.",
        "inputSchema": {
            "type": "object",
            "properties": {},
        },
    },
    {
        ...
        "description": "Return Brepwright runtime status and active Fusion document availability.",
        "inputSchema": {
            "type": "object",
            "properties": {},
        },
    ...
    {
        "name": GET_ACTIVE_DESIGN_INFO,
        "description": "Inspect the active Fusion design: bodies, components, bounding boxes, and counts.",
        "inputSchema": {
            "type": "object",
            "properties": {},
        },
    ...
    # === Workflow-first CAD helpers ===
    {
        "name": CREATE_MOUNTING_PLATE,
        "description": "Create a practical mounting plate with rounded edges and a four-hole pattern. All dimensions in mm.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "width": {"type": "number", "description": "Plate width in mm (default: 80)", "default": 80},
                "depth": {"type": "number", "description": "Plate depth in mm (default: 50)", "default": 50},
                "thickness": {"type": "number", "description": "Plate thickness in mm (default: 4)", "default": 4},
                "corner_radius": {"type": "number", "description": "Fillet radius in mm (default: 2)", "default": 2},
                "hole_diameter": {"type": "number", "description": "Mounting hole diameter in mm (default: 4)", "default": 4},
                "hole_offset_x": {"type": "number", "description": "Hole inset from left/right edges in mm (default: 10)", "default": 10},
                "hole_offset_y": {"type": "number", "description": "Hole inset from front/back edges in mm (default: 10)", "default": 10},
                "name": {"type": "string", "description": "Body name (default: MountingPlate)", "default": "MountingPlate"},
            },
        },
    },
    {
        "name": CREATE_ENCLOSURE_SHELL,
        "description": "Create a box-like enclosure shell with optional screw posts. All dimensions in mm.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "width": {"type": "number", "description": "Outer width in mm (default: 80)", "default": 80},
                "depth": {"type": "number", "description": "Outer depth in mm (default: 50)", "default": 50},
                "height": {"type": "number", "description": "Outer height in mm (default: 25)", "default": 25},
                "wall_thickness": {"type": "number", "description": "Wall thickness in mm (default: 2)", "default": 2},
                "corner_radius": {"type": "number", "description": "Outer fillet radius in mm (default: 1.5)", "default": 1.5},
                "post_diameter": {"type": "number", "description": "Screw post diameter in mm (default: 6)", "default": 6},
                "post_hole_diameter": {"type": "number", "description": "Post pilot hole diameter in mm (default: 2.5)", "default": 2.5},
                "add_posts": {"type": "boolean", "description": "Whether to add four screw posts (default: true)", "default": True},
                "name": {"type": "string", "description": "Body name (default: EnclosureShell)", "default": "EnclosureShell"},
            },
        },
    },
    {
        "name": CREATE_BRACKET,
        "description": "Create a simple L or U bracket with base mounting holes. All dimensions in mm.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "type": {"type": "string", "description": "Bracket type: L or U (default: L)", "default": "L"},
                "width": {"type": "number", "description": "Bracket width in mm (default: 60)", "default": 60},
                "depth": {"type": "number", "description": "Base depth in mm (default: 40)", "default": 40},
                "height": {"type": "number", "description": "Wall height in mm (default: 40)", "default": 40},
                "thickness": {"type": "number", "description": "Material thickness in mm (default: 4)", "default": 4},
                "hole_diameter": {"type": "number", "description": "Mounting hole diameter in mm (default: 4)", "default": 4},
                "name": {"type": "string", "description": "Body name prefix (default: Bracket)", "default": "Bracket"},
            },
        },
    },
    {
        "name": INSPECT_DESIGN,
        "description": "Return body summaries, physical properties, and warnings for the active design.",
        "inputSchema": {
            "type": "object",
            "properties": {},
        },
    ...
    {
        "name": EXPORT_DESIGN_PACK,
        "description": "Export STEP, STL, screenshot, and a JSON summary into one design-pack folder.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "output_dir": {"type": "string", "description": "Output folder path (default: ~/Desktop/brepwright-export)", "default": "~/Desktop/brepwright-export"},
                "base_name": {"type": "string", "description": "Base filename for exported files (default: brepwright-design)", "default": "brepwright-design"},
                "body_name": {"type": "string", "description": "Body to export as STL (default: first body)", "default": ""},
            },
        },
    },
    {
        "name": VALIDATE_PART_FOR_PRINTING,
        "description": "Run lightweight printability checks: solid bodies, body count, and bounding dimensions.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "min_wall_thickness": {"type": "number", "description": "Minimum warning threshold in mm (default: 1.2)", "default": 1.2},
            },
        },
    },
]
